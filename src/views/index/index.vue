  ...
  <div class="bigbox" style="padding:0 10px;">
    <div class="report">
      ...
      <div class="tab">
        ...
        <a href="javascript:void(0)" @click="goto('/testresult')" class="more">查看更多</a>
      </div>
    </div>
    <div class="supervision">
      ...
      <div class="tab">
        ...
        <a href="javascript:void(0)" @click="goto('/planscheme')" class="more">查看更多</a>
      </div>
    </div>
    <div class="facility">
      <h3>互联设备</h3>
      <div class="tab">
        ...
        <swiper  :options="swiperOption"  ref="mySwiper">
          <!-- slides -->
          <swiper-slide v-for="items in DeviceList" :key="items.ID"> <a @click="goto(items.DeviceUrl)" href="javascript:void(0)"><img  :src="items.DeviceImg" alt=""></a><p>{{items.DeviceName}}</p></swiper-slide>
    ...
    <div class="consult">
      ...
      <div class="tab">
        ...
        <a href="javascript:void(0)" @click="goto('/consult')" class="more">查看更多</a>
      </div>
    </div>
  </div>
</template>
