...
<div>
  ...
  <div class="top">
    ...
    <button type="button" @click="handleUserList" style="background:#006fe5 ;margin-left: 25%;margin-right:2%" class="layui-btn layui-btn-normal">开始检索</button>
  </div>
    ...
    <div class="consult">
      ...
      <div class="tab">
        <el-table ref="multipleTable" style="width: 100%;"
                  :data="userList" @selection-change="selectionChange"
        >
          ...
          <el-table-column label="真实姓名" >
            <template slot-scope="scope">
              <img v-if="scope.row.IsGroup" src="/static/img/zu.png">{{scope.row.RealName}}
            </template>
          </el-table-column>
