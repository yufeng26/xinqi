  ...
  <div class="detailPage">
    ...
    <div class="info">
      ...
      <div
        class="otherInfo"
        v-if="
          testresult.ExtendFieldList && testresult.ExtendFieldList.length > 0
        "
      >
        <h2>拓展字段</h2>
        <el-row>
    ...
    <div class="info">
      <el-row>
        ...
        <div v-if="dimisionList && dimisionList.length === 7">
...
export default {
  ...
  methods: {
    ...
    getdetail() {
      ...
      this.$TestResultAPI.getResultDetail(params, function (data) {
        if (data.Code == 1) {
          ...
          if (data.Result.DimisionList && data.Result.DimisionList.length > 0) {
    ...
    //导出报告
    exportWord() {
      this.$TestResultAPI.ReportResultCpm(this.$route.query.ID);
