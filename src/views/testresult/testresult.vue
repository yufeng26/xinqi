<template>
  ...
  <div class="top top_bottom">
    ...
    <button type="button" @click="handleUserList" style="background:#006fe5 ;margin-left: 10%;" class="layui-btn layui-btn-normal">开始检索</button>
  </div>
  <div class="bigbox">
    <div class="consult">
      ...
      <button type="button" @click="handlePLDelete" style="background:#ff433f ;"  class="layui-btn layui-btn-normal" v-if="menuModel.deleteUsable">批量删除</button>
      <div class="tab">
        ...
        >
          ...
          <el-table-column label="操作"  width="400px">
            <template slot-scope="scope">
              ...
              <el-button type="warning" v-if="menuModel.exportUsable">{{menuModel.export}}</el-button>
