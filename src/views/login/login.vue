        ...
        <div class="l-l">
          ...
          <el-tabs v-model="activeName">
            <el-tab-pane label="用户登录" name="first">
              ...
              <!-- el-form-item：表单项  -->
              <el-form @submit.native.prevent="login" ref="form" status-icon :rules="rules" :model="form" label-width="80px">
                ...
                <el-form-item  prop="password">
                  ...
                  <el-input type="password"  v-model="form.password" placeholder="请输入密码"  prefix-icon="iconfont icon-mima"></el-input>
                </el-form-item>
                <el-form-item>
                  <!--使用@语法糖绑定事件-->
...
console.log(data)
  ...
  if(that.$store.state.accessToken){
    ...
    // 将登录名使用vuex传递到Home页面
    setTimeout(function(){ that.$router.push('\home')},1000)
  }
