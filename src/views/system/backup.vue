      ...
      <div class="content">
        <p style="display: flex; justify-content: flex-start">
          <button
            type="button"
            @click="recovery"
            style="background: #0070e5; margin: 20px 0"
            class="layui-btn layui-btn-normal"
          >
            备份
          </button>
          <span style="color: red; margin: 30px 0 30px 30px; font-size: 16px"
            >*特别提示：建议您定期备份数据库，一面重要的数据遗失！</span
          >
        </p>
        <div class="tab">
          <el-table style="width: 100%" :data="userList">
            <el-table-column type="index"> </el-table-column>
            <el-table-column label="名称" prop="db_BakName"> </el-table-column>

            <el-table-column label="相关操作">
              <template slot-scope="scope">
                <el-button
                  @click.native.prevent="downloadRow(scope.row)"
                  type="primary"
                  size="mini"
                  >下载</el-button
                >
