<template>
  <div><div class="top">
    ...
    <div class="selects">
      <label style="width: 24%;">训练主题：</label>
      <div class="selecount">
    ...
    <div class="bigbox">
      <div class="consult">
        <button type="button" style="background:#01c8e7 ;" class="layui-btn layui-btn-normal"  v-if="menuModel.exportUsable">批量导出</button>
        ...
        <div class="tab">
          ...
          >
            ...
            <el-table-column label="训练主题" prop="TopicName" width="200px">
            </el-table-column>
  ...
  export default {
    ...
    data(){
      return {
        ...
        topicID:"",
        deviceID:"5978d929ba4b11e99a4f00cfe04d1a01",
        currentPage:1, //初始页
        pagesize:10,    //    每页的数据
        userList: [],
        totalRecords:0,
    ...
    methods:{
      ...
      handleUserList() {
        ...
        this.userList = this.$TestResultAPI.getTestResultPageList(param, function (data) {
