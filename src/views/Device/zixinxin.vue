  ...
  <div class="searchPage">
    <div class="searchBox">
      <el-row class="mtop15">
        ...
        <el-col :span="6">
          <label class="searchLabel">训练主题：</label>
          <div class="searchData">
            <el-select
              :clearable="true"
              v-model="topicName"
    ...
    <div class="searchData">
      ...
      >
        ...
        <el-table-column label="训练主题" prop="TitleName" width="200px">
        </el-table-column>

        <el-table-column label="真实姓名" prop="RealName" width="130px">
        </el-table-column>
        <el-table-column label="训练结果" width="300px">
...
export default {
  ...
  methods: {
    ...
    handleUserList() {
      ...
      param.append("reportType", 4); //1:击打、2:呐喊、3:拥抱、4:自信心
    ...
    //查看
    editRow(row) {
      this.$router.push({ name: "pubreport", query: { ID: row.Id } });
    },
    //导出
    exportDevice(row) {
      this.$PlanSchemeAPI.ReportResultZxx(row.Id);
    }
  },
  computed: {
    /* 转树形数据 */
