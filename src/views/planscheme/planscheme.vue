<template>
  <div>
    <div class="top">
      ...
      <button type="button" style="background:#006fe5 ;margin-left: 50%;" class="layui-btn layui-btn-normal">开始检索</button>
    </div>
    <div class="bigbox">
      <div class="consult">
        <button type="button" style="background:#01c8e7 ;" class="layui-btn layui-btn-normal" v-if="menuModel.exportUsable">批量导出</button>
        <button type="button" style="background:#ff433f ;"  class="layui-btn layui-btn-normal" v-if="menuModel.deleteUsable">批量删除</button>
        <div class="tab">
          ...
          >
            ...
            <el-table-column label="操作" >
              <template slot-scope="scope">
                <el-button type="success" @click.native.prevent="editRow(scope.row)" v-if="menuModel.lookUsable">{{menuModel.look}}</el-button>
    ...
    export default {
      ...
      methods:{
        ...
        handleUserList() {
          ...
          this.userList = this.$PlanSchemeAPI.getPlanSchemePageList(param, function (data) {
